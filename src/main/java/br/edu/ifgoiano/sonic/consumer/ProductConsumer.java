package br.edu.ifgoiano.sonic.consumer;
...
import br.edu.ifgoiano.sonic.service.RabbitMQService;
...
public class ProductConsumer {
	...
	@RabbitListener(queues = RabbitMQConstants.QUEUE_HEAVY_PRODUCTS)
